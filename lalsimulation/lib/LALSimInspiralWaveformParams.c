...
DEFINE_INSERT_FUNC(NonGRMassiveGravitonMass, REAL8, "mgmass", 0)
DEFINE_INSERT_FUNC(NonGRParityAeff, REAL8, "parity_Aeff_phi", 0)
DEFINE_INSERT_FUNC(NonGRParitylog10Aeff, REAL8, "parity_log10Aeff_phi", 0)
DEFINE_INSERT_FUNC(NonGRParitybeta, INT4, "parity_beta_mu", 0)
DEFINE_INSERT_FUNC(NonGRParityAh, REAL8, "parity_Aeff_amp", 0)
DEFINE_INSERT_FUNC(NonGRParitybetanu, INT4, "parity_beta_nu", 0)
