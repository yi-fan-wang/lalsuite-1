...
#include "LALSimulationVCSInfo.h"

/*
 * Utility for printing version information for LALSimulation
 */
...
int main(int argc, char **argv) {
  ...
  char *str = XLALVCSInfoString( lalSimulationVCSInfoList, verbose, NULL );
